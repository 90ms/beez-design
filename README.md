...
현재는 초기 아키텍처와 Foundation을 정리하는 단계입니다. 아직 Stable 컴포넌트 artifact를 배포하지 않았습니다.
...
BEEZ is currently in its initial architecture and foundation stage. No stable component artifact has been released yet.
